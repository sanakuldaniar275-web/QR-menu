(()=>{
  ...
  // Curated dish-by-dish photos only. No random fallback images.
  // GREEN BAR supplied photos are pre-cropped to the actual food area,
  // so cards and detail modals use the same clean landscape image.
  const verified = {
    'Пивное ассорти':'/greenbar-photos/beer-assorti-card.webp',
    'Курица в сливочном соусе':'/greenbar-photos/chicken-cream-rice-card.webp',
    'Рамен с курицей':'/greenbar-photos/ramen-chicken-card.webp',
    'Куырдак из баранины':'/greenbar-photos/kuyrdak-lamb-card.webp',
    'Америка темпура':'/greenbar-photos/fried-rolls-card.webp',
