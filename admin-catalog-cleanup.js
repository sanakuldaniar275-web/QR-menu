(()=>{
 const TYPES={food:{noun:'блюдо',title:'Меню',category:'Категории меню',add:'Добавить блюдо',photo:'Фотография блюда',name:'Название блюда',desc:'Описание блюда',list:'Блюда',stock:''},products:{noun:'товар',title:'Каталог',category:'Категории товаров',add:'Добавить товар',photo:'Фотография товара',name:'Название товара',desc:'Описание товара',list:'Товары',stock:'В наличии'},flowers:{noun:'товар',title:'Каталог',category:'Категории товаров',add:'Добавить товар',photo:'Фотография товара',name:'Название букета / товара',desc:'Описание товара',list:'Товары',stock:'В наличии'},auto:{noun:'автомобиль',title:'Каталог',category:'Категории автомобилей',add:'Добавить автомобиль',photo:'Фотография автомобиля',name:'Марка и модель',desc:'Описание автомобиля',list:'Автомобили',stock:'В наличии'},services:{noun:'услуга',title:'Услуги',category:'Категории услуг',add:'Добавить услугу',photo:'Фотография услуги',name:'Название услуги',desc:'Описание услуги',list:'Услуги',stock:'Доступна'},other:{noun:'позиция',title:'Каталог',category:'Категории',add:'Добавить позицию',photo:'Фотография',name:'Название',desc:'Описание',list:'Позиции',stock:'Активна'}};
